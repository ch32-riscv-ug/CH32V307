...
#curl -z CH32V307DS0.PDF -o CH32V307DS0.PDF https://www.wch-ic.com/download/file?id=356 #(skip) Same file as CH32V20x_30xDS0.PDF
...
curl -z CH32V20x_30xDS0.PDF -o CH32V20x_30xDS0.PDF https://file.wch.cn/download/file?id=355
# https://www.wch.cn/downloads/CH32V307DS0_PDF.html
#curl -z CH32V307DS0.PDF -o CH32V307DS0.PDF https://file.wch.cn/download/file?id=416 #(skip)  Same file as CH32V20x_30xDS0.PDF
...
curl -z CH32V307EVT.ZIP -o CH32V307EVT.ZIP https://file.wch.cn/download/file?id=356
rm -rfv EVT
unzip -O GB2312 *.ZIP
